      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center relative z-10">
        ...
        <div className="lg:col-span-5 relative">
          <div className="relative h-full group">
            <Image
              ...
              height={1600}
              width={900}
              className="object-contain p-6 h-full rounded-lg shadow-[0_8px_30px_rgb(0,0,0,0.12)] transform transition-transform hover:scale-[1.02] duration-300"
            />
          </div>
        </div>
        ...
        <div className="lg:col-span-7 space-y-8">
          ...
          <div className="pt-6 flex flex-col sm:flex-row gap-4">
            ...
            <Button
              variant="outline"
              className="px-8 py-6 rounded-xl border-2 border-gray-200 dark:border-gray-800 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-300"
            >
              View Templates
            </Button>
          </div>
