...
const templateStyles = {
  modern: {
    ...
    sectionHeader:
      "text-2xl font-semibold text-gray-700 mb-3 flex items-center after:content-[''] after:flex-grow after:h-[1px] after:bg-gray-200 after:ml-4",
    skills: "flex flex-wrap gap-2",
    skillItem:
      "bg-blue-50 text-blue-700 px-3 py-1 rounded-full text-sm font-medium shadow-sm hover:shadow-md transition-shadow",
    text: "text-gray-600",
  ...
  classic: {
    ...
    sectionHeader:
      "text-xl font-bold text-black mb-3 uppercase border-b border-gray-400 pb-1",
  ...
  minimal: {
    container:
      "bg-white p-8 border-t-4 border-blue-500 max-w-4xl mx-auto shadow-sm",
    nameContainer: "mb-6",
    name: "text-3xl font-sans font-bold text-gray-900",
    title: "text-lg text-gray-400 mt-1 font-light",
    sectionHeader:
      "text-xl font-medium text-gray-800 mb-3 border-b border-gray-200 pb-1",
    skills: "flex flex-wrap gap-2",
  ...
  creative: {
    container:
      "bg-gradient-to-br from-purple-50 to-blue-50 p-8 rounded-lg max-w-4xl mx-auto shadow-md",
    ...
    sectionHeader:
      "text-2xl font-bold mb-4 bg-gradient-to-r from-purple-600 to-blue-500 bg-clip-text text-transparent inline-block",
    skills: "flex flex-wrap gap-2",
    skillItem:
      "bg-white bg-opacity-50 backdrop-filter backdrop-blur-sm px-3 py-1 rounded-full text-sm border border-purple-200 text-purple-700",
    text: "text-gray-600",
  ...
  professional: {
    container:
      "bg-white p-8 border-l-8 border-gray-700 max-w-4xl mx-auto shadow-md",
    ...
    sectionHeader:
      "text-xl font-bold text-gray-800 mb-3 uppercase border-b border-gray-300 pb-1",
    skills: "grid grid-cols-3 gap-2 sm:grid-cols-4",
    skillItem:
      "bg-gray-100 text-gray-800 px-3 py-2 text-center text-sm border-l-2 border-gray-700",
    text: "text-gray-700 leading-relaxed",
    projectTitle: "text-lg font-bold text-gray-800",
    projectTech:
      "text-sm font-medium text-gray-600 border-l-2 border-gray-400 pl-2",
  ...
  latex: {
    container:
      "bg-white p-8 max-w-4xl mx-auto shadow-md border border-gray-300 font-['Computer_Modern',_'Latin_Modern_Roman',_'Times_New_Roman',_serif]",
    nameContainer: "text-center pb-4 mb-6 border-b-2 border-black",
    name: "text-3xl font-bold text-black tracking-tight font-['Computer_Modern',_'Latin_Modern_Roman',_'Times_New_Roman',_serif]",
    title: "text-lg text-gray-700 mt-2 font-['Computer_Modern',_'Latin_Modern_Roman',_'Times_New_Roman',_serif]",
    sectionHeader:
      "text-xl font-bold text-black mb-3 uppercase border-b-2 border-black pb-1 tracking-wider font-['Computer_Modern',_'Latin_Modern_Roman',_'Times_New_Roman',_serif]",
    skills: "grid grid-cols-4 gap-1",
    skillItem:
      "bg-gray-200 text-black px-2 py-1 text-center text-xs border border-gray-400 font-['Computer_Modern_Typewriter',_'Courier_New',_monospace]",
    text: "text-black leading-tight text-sm font-['Computer_Modern',_'Latin_Modern_Roman',_'Times_New_Roman',_serif]",
    projectTitle: "text-lg font-bold text-black font-['Computer_Modern',_'Latin_Modern_Roman',_'Times_New_Roman',_serif]",
    projectTech: "text-xs text-gray-600 uppercase tracking-wider font-['Computer_Modern_Typewriter',_'Courier_New',_monospace]",
    expTitle: "text-lg font-bold text-black font-['Computer_Modern',_'Latin_Modern_Roman',_'Times_New_Roman',_serif]",
    expDetails: "text-xs text-gray-600 uppercase tracking-wider mb-1 font-['Computer_Modern_Typewriter',_'Courier_New',_monospace]",
    eduTitle: "text-lg font-bold text-black font-['Computer_Modern',_'Latin_Modern_Roman',_'Times_New_Roman',_serif]",
    contactList: "grid grid-cols-1 gap-1 text-black text-sm font-['Computer_Modern',_'Latin_Modern_Roman',_'Times_New_Roman',_serif]",
  },
};
            ...
            (project, idx) =>
              project.name && (
                <div key={idx} className="mb-4">
                  ...
                  <p className={`${styles.text} mt-1 whitespace-pre-line`}>
                    {project.description}
                  </p>
                </div>
              )
            ...
            (exp, idx) =>
              exp.title && (
                <div key={idx} className="mb-5">
                  ...
                  <p className={`${styles.text} mt-2 whitespace-pre-line`}>
                    {exp.description}
                  </p>
                </div>
              )
      ...
      {data.achievements?.length > 0 && (
        <section className="mt-6">
          ...
          <ul
            className={
              template === "professional"
                ? `${styles.text} list-none space-y-2`
                : template === "creative"
                ? `${styles.text} list-none space-y-2`
              ...
              <li
                ...
                className={
                  template === "professional"
                    ...
                    : template === "creative"
                    ? "bg-white bg-opacity-30 p-2 rounded"
                    : ""
                }
              >
                {ach}
