export const metadata = {
  title: "Pricing Plans | ResumeMax",
  description: "Choose the perfect plan for your resume needs. From free basic templates to advanced AI optimization features. Start creating your perfect resume today.",
};
