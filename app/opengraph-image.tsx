    ...
    (
      <div
        style={{
          ...
          backgroundImage: 'radial-gradient(circle at 25% 25%, #1e293b 0%, transparent 50%), radial-gradient(circle at 75% 75%, #1e40af 0%, transparent 50%)',
      ...
      >
        ...
        >
          ...
          >
            {['AI-Powered', 'Real-time Building', 'ATS Optimized'].map((feature) => (
              <div
                key={feature}
                style={{
                  padding: '12px 24px',
