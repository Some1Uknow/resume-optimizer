...
import { ArrowRight, FileText, Sparkles, Star, CheckCircle2 } from "lucide-react"
      ...
      <main className="flex-1">
              ...
              <div className="space-y-4 max-w-3xl">
                <div className="inline-block rounded-full bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-blue-900/40 dark:to-indigo-900/40 px-4 py-1.5 text-sm shadow-inner">
                  <span className="flex items-center gap-1.5">
                    ...
                    <span className="text-blue-800 dark:text-blue-300 font-medium">AI-Powered Resume Builder</span>
                  </span>
                </div>
                ...
                <p className="mx-auto max-w-[800px] text-xl text-slate-600 dark:text-slate-300 md:text-2xl/relaxed">
                  Type naturally, watch your resume build in real-time. Our AI optimizes your content for ATS systems
                  and hiring managers.
                </p>
              </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                    <div className="bg-slate-50 dark:bg-slate-800/50 p-6 border-r border-slate-200 dark:border-slate-700/50">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-4 shadow-sm ml-6">
                          <p className="text-slate-800 dark:text-slate-200">
                            I worked at Google from 2018-2022 as a Senior Software Engineer on the Cloud Platform team.
                            I led a team of 5 engineers and implemented a new authentication system that improved
                            security by 40%.
                          </p>
                        </div>
                        <div className="bg-white dark:bg-slate-700/50 rounded-2xl p-4 shadow-sm">
                        ...
                        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-4 shadow-sm ml-6">
                          <p className="text-slate-800 dark:text-slate-200">
                            I`&apos;`ve added Python and machine learning to your skills section. Would you like to add any
                    ...
                    <div className="bg-white dark:bg-slate-900 p-6">
                      <div className="text-center mb-6">
                        ...
                        <p className="text-lg text-slate-600 dark:text-slate-400">Senior Software Engineer</p>
                      ...
                      <div className="space-y-4">
                            ...
                            <div>
                              <div className="flex justify-between items-start">
                                <div>
                                  ...
                                  <p className="text-slate-600 dark:text-slate-400">Google, Mountain View, CA</p>
                                </div>
                                <span className="text-slate-600 dark:text-slate-400 text-sm">2018 - 2022</span>
                              </div>
                              <p className="mt-1 text-slate-700 dark:text-slate-300">
                                Led a team of 5 engineers on the Cloud Platform. Implemented a new authentication system
                                that improved security by 40%.
                              </p>
                            </div>
                          </div>
                        </div>
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2 mt-2">
                            {["JavaScript", "TypeScript", "React", "Node.js", "Python", "Machine Learning"].map(
                              (skill, index) => (
                                <span
                                  key={index}
          ...
          <div className="container px-4 md:px-6">
            <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center space-y-4 text-center">
              <div className="inline-block rounded-full bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-blue-900/40 dark:to-indigo-900/40 px-4 py-1.5 text-sm shadow-inner mb-4">
                <span className="text-blue-800 dark:text-blue-300 font-medium">Features</span>
              </div>
              ...
              {[
                {
                  ...
                  description: "Describe your experience in natural language and watch your resume update instantly",
                  icon: <Sparkles className="h-12 w-12 text-blue-600 dark:text-blue-400" />,
                },
                {
                  title: "ATS Optimization",
                  description: "Our AI ensures your resume passes through Applicant Tracking Systems with ease",
                  icon: <CheckCircle2 className="h-12 w-12 text-blue-600 dark:text-blue-400" />,
                },
                {
                  title: "Beautiful Templates",
                  description: "Choose from professionally designed templates that stand out to recruiters",
                  icon: <Star className="h-12 w-12 text-blue-600 dark:text-blue-400" />,
                },
              ].map((feature, index) => (
                <div
                  key={index}
        ...
        <section id="pricing" className="py-20 relative">
          ...
          <div className="container px-4 md:px-6">
            <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center space-y-4 text-center">
              <div className="inline-block rounded-full bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-blue-900/40 dark:to-indigo-900/40 px-4 py-1.5 text-sm shadow-inner mb-4">
                <span className="text-blue-800 dark:text-blue-300 font-medium">Pricing</span>
              </div>
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight bg-gradient-to-r from-slate-900 via-blue-800 to-indigo-900 dark:from-white dark:via-blue-200 dark:to-indigo-200 text-transparent bg-clip-text">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 py-12 md:grid-cols-3">
              {[
                ...
                <div
                  key={index}
                  className={`relative flex flex-col rounded-3xl ${plan.popular ? "bg-gradient-to-b from-blue-600 to-indigo-700 dark:from-blue-500 dark:to-indigo-600 text-white" : "bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800"} p-8 shadow-xl`}
                >
                  {plan.popular && (
                  ...
                  <div className="flex-1 space-y-6">
                    <h3
                      className={`text-2xl font-bold ${plan.popular ? "text-white" : "text-slate-900 dark:text-white"}`}
                    >
                      {plan.title}
                    </h3>
                    <div className="flex items-end gap-1">
                      <div
                        className={`text-4xl font-extrabold ${plan.popular ? "text-white" : "text-slate-900 dark:text-white"}`}
                      >
                        {plan.price}
                      </div>
                      {plan.period && (
                        <div
                          className={`text-lg ${plan.popular ? "text-blue-100" : "text-slate-600 dark:text-slate-400"}`}
                        >
                          {plan.period}
                        </div>
                      )}
                      ...
                      {plan.features.map((feature, i) => (
                        <li key={i} className="flex items-center gap-2">
                          <svg
                            ...
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            className={`h-5 w-5 ${plan.popular ? "text-blue-200" : "text-blue-600 dark:text-blue-400"}`}
                          >
                  ...
                  <div className="mt-8">
                    <Button
                      className={`w-full rounded-full py-6 ${plan.popular ? "bg-white text-blue-700 hover:bg-blue-50" : "bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white"} shadow-lg hover:shadow-xl transition-all duration-300`}
                    >
                      Get Started
                    </Button>
                  </div>
        ...
        <section id="testimonials" className="py-20">
          <div className="container px-4 md:px-6">
            <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center space-y-4 text-center">
              ...
              <p className="max-w-[85%] text-xl text-slate-600 dark:text-slate-300">
                Join thousands of satisfied job seekers who found their dream job with ResumeMax
              </p>
            </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mb-8 text-xl text-slate-600 dark:text-slate-300">
                Join thousands of job seekers who have already landed their dream jobs with ResumeMax.
              </p>
              <Button
                asChild
                size="lg"
      ...
      <footer className="border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 py-12">
        <div className="container px-4 md:px-6">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              <h3 className="font-semibold text-lg mb-4 text-slate-900 dark:text-white">Product</h3>
            ...
            <div>
              <h3 className="font-semibold text-lg mb-4 text-slate-900 dark:text-white">Legal</h3>
              <ul className="space-y-2">
                <li>
                  <Link
                    href="#"
