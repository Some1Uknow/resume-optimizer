    ...
    (
      <div
        style={{
          ...
          backgroundImage: 'radial-gradient(circle at 30% 40%, #1e293b 0%, transparent 50%), radial-gradient(circle at 80% 20%, #1e40af 0%, transparent 50%)',
      ...
      >
        ...
        >
          ...
          >
            Type naturally, watch your resume build in real-time
          </div>
          ...
          >
            {['AI-Powered', 'ATS Optimized'].map((feature) => (
              <div
                key={feature}
                style={{
                  padding: '10px 20px',
